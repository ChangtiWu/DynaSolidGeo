function visual(mode, azimuth, elevation, point_O, point_O1, point_A, point_C, point_A1, point_B1)
    ...
    Z = Z * h;
    surf(X, Y, Z, 'FaceColor', [0.3 0.7 0.9], 'EdgeColor', 'none', 'FaceAlpha', 0.3);

    theta_circle = linspace(0, 2*pi, n_pts);
    x_circle = r * cos(theta_circle);
    y_circle = r * sin(theta_circle);
    patch(x_circle, y_circle, zeros(1, n_pts), [0.3 0.7 0.9], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'LineStyle', '--');
    patch(x_circle, y_circle, h*ones(1, n_pts), [0.3 0.7 0.9], 'FaceAlpha', 0.3, 'EdgeColor', 'k', 'LineStyle', '-');

    plot3([O1(1), B1(1)], [O1(2), B1(2)], [O1(3), B1(3)], 'r-', 'LineWidth', 2);
    plot3([O(1), C(1)], [O(2), C(2)], [O(3), C(3)], 'r-', 'LineWidth', 2);

    plot3([O1(1), A1(1)], [O1(2), A1(2)], [O1(3), A1(3)], 'k-', 'LineWidth', 1);
    plot3([A(1), A1(1)], [A(2), A1(2)], [A(3), A1(3)], 'k-', 'LineWidth', 1);
