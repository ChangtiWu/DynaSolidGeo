function visual(mode, azimuth, elevation, point_C, point_D, point_A, point_B, point_P, point_E)
    close all;
    ...
    all_points_labels = {point_A, point_B, point_C, point_D, point_P, point_E};
    all_points_coords = {A, B, C, D, P, E};
    offsets = {[0.2, -0.2, 0], [0, 0.3, 0], [-0.3, 0.2, 0], [-0.2, -0.2, 0], [0, 0, 0.3], [0.3, 0, 0]};
