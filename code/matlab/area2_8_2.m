function visual(mode, azimuth, elevation, point_A, point_B1, point_C, point_D1, point_B, point_D, point_A1, point_C1)
    ...
    plot3([B1(1), A(1)], [B1(2), A(2)], [B1(3), A(3)], 'k--', 'LineWidth', 2);
    
    
    plot3([A(1), C(1)], [A(2), C(2)], [A(3), C(3)], 'k--', 'LineWidth', 1.5);
    plot3([D1(1), C(1)], [D1(2), C(2)], [D1(3), C(3)], 'k--', 'LineWidth', 1.5);
    plot3([D(1), C(1)], [D(2), C(2)], [D(3), C(3)], 'k--', 'LineWidth', 1.5);
    plot3([A(1), D1(1)], [A(2), D1(2)], [A(3), D1(3)], 'k--', 'LineWidth', 1.5);
    
    
    text(A(1)-0.1, A(2)-0.1, A(3)-0.1, point_A, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    text(B(1)+0.1, B(2)-0.1, B(3)-0.1, point_B, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    text(C(1)+0.1, C(2)+0.1, C(3)-0.1, point_C, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    text(D(1)-0.1, D(2)+0.1, D(3)-0.1, point_D, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    ...
    text(D1(1)-0.1, D1(2)+0.1, D1(3)+0.1, point_D1, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
