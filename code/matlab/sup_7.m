function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D)
    ...
    text(A(1)+0.1, A(2), A(3), point_A, 'FontSize', 12, 'Color', 'k');
    text(B(1), B(2)+0.1, B(3), point_B, 'FontSize', 12, 'Color', 'k');
    text(C(1)-0.1, C(2), C(3), point_C, 'FontSize', 12, 'Color', 'k');
    text(D(1), D(2), D(3)+0.1, point_D, 'FontSize', 12, 'Color', 'k');
