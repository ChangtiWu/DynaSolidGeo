function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_A1, point_B1, point_C1, point_D1)
    ...
    plot3([xA1, xA], [yA1, yA], [zA1, zA], 'k-', 'LineWidth', 2); 
    plot3([xC1, xC], [yC1, yC], [zC1, zC], 'k-', 'LineWidth', 2); 
    plot3([xB, xC], [yB, yC], [zB, zC], 'k-', 'LineWidth', 2); 
    
    
    plot3([xD, xD1], [yD, yD1], [zD, zD1], 'k-', 'LineWidth', 1.5); 
    plot3([xA, xD], [yA, yD], [zA, zD], 'k-', 'LineWidth', 1.5); 
    plot3([xD, xC], [yD, yC], [zD, zC], 'k-', 'LineWidth', 1.5); 
    plot3([xD, xB1], [yD, yB1], [zD, zB1], 'k--', 'LineWidth', 2); 
