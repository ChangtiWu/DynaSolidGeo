function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_A1, point_B1, point_C1, point_D1, point_E, point_F)
    ...
    L = 2;
    D = [0, 0, 0]; C = [0, L, 0]; B = [L, L, 0]; A = [L, 0, 0];
    D1 = [0, 0, L]; C1 = [0, L, L]; B1 = [L, L, L]; A1 = [L, 0, L];
    ...
    plot3([E(1), F(1)], [E(2), F(2)], [E(3), E(3)], 'k--', 'LineWidth', 2);
    plot3([F(1), B1(1)], [F(2), B1(2)], [F(3), B1(3)], 'k--', 'LineWidth', 2);
    ...
    text(E(1)+0.15, E(2), E(3)-0.1, point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(F(1), F(2)+0.15, F(3)-0.1, point_F, 'FontSize', 14, 'FontWeight', 'bold');
