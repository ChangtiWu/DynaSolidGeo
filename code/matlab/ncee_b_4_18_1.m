function visual(mode, azimuth, elevation, point_A, point_C, point_B, point_D, point_O, point_E, point_F, point_H, point_D_prime)
    close all;
    ...
    points_to_plot = {A, B, C, D, E, F, H, O, D_prime};
    labels = {point_A, point_B, point_C, point_D, point_E, point_F, point_H, point_O, point_D_prime};
