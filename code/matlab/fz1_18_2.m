...
function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_F, point_P, point_M)
    ...
    text(A_prime(1)+0.1, A_prime(2), A_prime(3)+0.1, point_P, 'FontSize', 14, 'FontWeight', 'bold');
    text(B(1)-0.1, B(2)-0.1, B(3)+0.1, point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(C(1)-0.1, C(2)-0.1, C(3), point_B, 'FontSize', 14, 'FontWeight', 'bold');
    text(D(1)-0.1, D(2)-0.1, D(3), point_F, 'FontSize', 14, 'FontWeight', 'bold');
    text(E(1)+0.1, E(2)-0.1, E(3), point_D, 'FontSize', 14, 'FontWeight', 'bold');
