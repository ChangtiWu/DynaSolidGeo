function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_G, point_F)
    close all;
    ...
    patch([A(1), D(1), E(1)], [A(2), D(2), E(2)], [A(3), D(3), E(3)], 'c', 'FaceAlpha', 0.2);
    patch([A(1), E(1), F(1)], [A(2), E(2), F(2)], [A(3), E(3), F(3)], 'm', 'FaceAlpha', 0.3);
    patch([B(1), E(1), C(1)], [B(2), E(2), C(2)], [B(3), E(3), C(3)], 'g', 'FaceAlpha', 0.2);
    ...
    plot3([G(1), F(1)], [G(2), F(2)], [G(3), F(3)], 'b-', 'LineWidth', 2);
    
    all_points = {A, B, C, D, E, F, G};
