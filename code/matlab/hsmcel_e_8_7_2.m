function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1)
    ...
    all_points_labels = {point_A, point_B, point_C, point_A1, point_B1, point_C1};
    all_points_coords = {A, B, C, A1, B1, C1};
    offsets = {[-0.1, -0.05, -0.05], [0, 0.1, 0], [0.1, -0.05, 0], ...
               [-0.1, -0.05, 0], [0, 0.1, 0], [0.1, 0, 0.05]};
