function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_E, point_F, point_D)
    ...
    all_points = {A, B, C, A1, B1, C1, E, F, D};
    ...
    text(B1(1)-0.25, B1(2)-0.25, B1(3)+0.25, point_B1, 'FontSize', 12, 'FontWeight', 'bold');
    text(C1(1)-0.15, C1(2)+0.15, C1(3), point_C1, 'FontSize', 12, 'FontWeight', 'bold');
    text(E(1), E(2), E(3)-0.2, point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(F(1), F(2)+0.2, F(3), point_F, 'FontSize', 14, 'FontWeight', 'bold');
    text(D(1), D(2)-0.2, D(3)+0.1, point_D, 'FontSize', 14, 'FontWeight', 'bold');
