function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_A_prime)
    ...
    text(A(1)-0.3, A(2)-0.3, A(3)+0.3, point_A, 'FontSize', 14, 'FontWeight', 'bold');
    text(B(1)-0.5, B(2)-0.3, B(3), point_B, 'FontSize', 14, 'FontWeight', 'bold');
    ...
    text(E(1)-0.5, E(2)-0.3, E(3)+0.2, point_E, 'FontSize', 14, 'FontWeight', 'bold');
