function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_A1, point_B1, point_C1, point_D1, point_M, point_P)
    ...
    plot3([M(1), P(1)], [M(2), P(2)], [M(3), P(3)], 'k--', 'LineWidth', 1.5);
