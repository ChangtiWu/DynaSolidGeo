function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_M, point_N, point_P, point_E, point_F, point_O)
    close all;
    ...
    text(O(1), O(2)-0.5, O(3), point_O, 'FontSize', 12, 'FontWeight', 'bold');
