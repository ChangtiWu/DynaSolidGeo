function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_D, point_E)
    ...
    plot3([B1(1), E(1)], [B1(2), E(2)], [B1(3), E(3)], 'k--', 'LineWidth', 2);
    ...
    all_points_labels = {point_A, point_B, point_C, point_A1, point_B1, point_C1, point_D, point_E};
    all_points_coords = {A, B, C, A1, B1, C1, D, E};
    offsets = {[0, 0.2, 0], [-0.2, -0.1, 0], [0.2, -0.1, 0], [0, 0.2, 0.1], ...
               [-0.2, 0, 0.1], [0.2, 0, 0.1], [0, -0.2, 0], [-0.2, 0, 0]};
