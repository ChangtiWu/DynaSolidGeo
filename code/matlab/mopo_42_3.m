function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_F, point_K, point_G)
    ...
    D = [1, sqrt(3), 0];          
    C = [3, sqrt(3), 0];          
    F = [1.5, sqrt(3)/2, sqrt(3)];
    E = [0.5, 3*sqrt(3)/2, sqrt(3)]; 
    ...
    text(F(1), F(2)-0.2, F(3)+0.1, point_F, 'FontSize', 14, 'FontWeight', 'bold');
