function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_E, point_F)
    ...
    E = [(P(1)+C(1))/2, (P(2)+C(2))/2, (P(3)+C(3))/2];
    ...
    text(D(1)-0.5, D(2)+0.3, D(3)-0.8, point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(P(1), P(2), P(3)+0.5, point_P, 'FontSize', 14, 'FontWeight', 'bold');
