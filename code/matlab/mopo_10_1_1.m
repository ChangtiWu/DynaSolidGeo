function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_G, point_E, point_D, point_F)
    ...
    plot3([G(1), D(1)], [G(2), D(2)], [G(3), D(3)], 'k--', 'LineWidth', 1.5);
    plot3([E(1), F(1)], [E(2), F(2)], [E(3), F(3)], 'k--', 'LineWidth', 1.5);
    plot3([D(1), F(1)], [D(2), F(2)], [D(3), F(3)], 'k--', 'LineWidth', 1.5);
    
    
    plot3([A1(1), G(1)], [A1(2), G(2)], [A1(3), G(3)], 'k--', 'LineWidth', 1.5);
    plot3([G(1), B1(1)], [G(2), B1(2)], [G(3), B1(3)], 'k--', 'LineWidth', 1.5);
