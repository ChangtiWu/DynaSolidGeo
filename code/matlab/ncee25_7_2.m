...
function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_O)
    ...
    text(A(1)-0.2, A(2)-0.2, A(3), point_A, 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'black');
    text(B(1)+0.1, B(2)-0.2, B(3), point_B, 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'black');
    text(C(1)+0.1, C(2)+0.1, C(3), point_C, 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'black');
    text(D(1)-0.2, D(2)+0.1, D(3), point_D, 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'black');
    text(P(1)-0.2, P(2)-0.2, P(3)+0.2, point_P, 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'black');
    ...
    plot3(P(1), P(2), P(3), 'ko', 'MarkerSize', 6, 'MarkerFaceColor', 'black');
