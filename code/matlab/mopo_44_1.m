function visual(mode, azimuth, elevation, point_A, point_M, point_N, point_B, point_D, point_C, point_E, point_F)
    ...
    text(F(1)-0.3, F(2)-0.2, F(3)+0.2, point_F, 'FontSize', 14, 'FontWeight', 'bold');  
