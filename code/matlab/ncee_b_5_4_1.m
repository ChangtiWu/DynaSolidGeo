function visual(mode, azimuth, elevation, point_P, point_D, point_C, point_A, point_B, point_E, point_F, point_G)
    close all;
    ...
    labels = {point_A, point_B, point_C, point_D, point_P, point_E, point_F, point_G};
