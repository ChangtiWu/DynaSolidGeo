function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_E, point_F, point_D)
    close all;
    ...
    all_points = {A, B, C, A1, B1, C1, D, E, F};
    ...
    text(C(1)-0.3, C(2)+0.2, C(3), point_C, 'FontSize', 14, 'FontWeight', 'bold');
    text(A1(1)+0.2, A1(2)-0.2, A1(3), point_A1, 'FontSize', 14, 'FontWeight', 'bold');
    text(B1(1), B1(2)-0.4, B1(3), point_B1, 'FontSize', 14, 'FontWeight', 'bold');
    text(C1(1)-0.4, C1(2)+0.2, C1(3), point_C1, 'FontSize', 14, 'FontWeight', 'bold');
    text(D(1)+0.1, D(2)-0.3, D(3), point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(E(1)+0.2, E(2)+0.2, E(3), point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(F(1)-0.3, F(2)+0.2, F(3), point_F, 'FontSize', 14, 'FontWeight', 'bold');
