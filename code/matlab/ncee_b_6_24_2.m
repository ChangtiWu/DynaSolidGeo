function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D)
    ...
    text(B(1)-0.3, B(2)+0.3, B(3), point_B, 'FontSize', 12, 'FontWeight', 'bold');
    text(C(1)+0.3, C(2)+0.3, C(3), point_C, 'FontSize', 12, 'FontWeight', 'bold');
    text(D(1)+0.3, D(2)-0.3, D(3), point_D, 'FontSize', 12, 'FontWeight', 'bold');
