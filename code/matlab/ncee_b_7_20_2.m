function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_E, point_F)
    ...
    patch([F(1), A(1), E(1)], [F(2), A(2), E(2)], [F(3), A(3), E(3)], 'm', 'FaceAlpha', 0.3);
    patch([P(1), A(1), E(1)], [P(2), A(2), E(2)], [P(3), A(3), E(3)], 'g', 'FaceAlpha', 0.2);
    ...
    plot3([E(1), F(1)], [E(2), F(2)], [E(3), F(3)], 'r--', 'LineWidth', 1.5);
    plot3([F(1), A(1)], [F(2), A(2)], [F(3), A(3)], 'r--', 'LineWidth', 1.5);
    plot3([A(1), G(1)], [A(2), G(2)], [A(3), G(3)], 'b--', 'LineWidth', 1.5);
    
    all_points = {A, B, C, D, P, E, F, G};
    ...
    text(F(1)+0.1, F(2), F(3), point_F, 'FontSize', 12, 'FontWeight', 'bold');
