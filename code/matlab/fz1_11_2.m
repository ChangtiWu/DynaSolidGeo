...
function visual(mode, azimuth, elevation, point_S, point_A, point_B, point_C, point_D, point_O, point_E)
    ...
    text(D(1)-0.1, D(2)+0.2, D(3), point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(S(1)-0.1, S(2), S(3)+0.3, point_S, 'FontSize', 14, 'FontWeight', 'bold');
