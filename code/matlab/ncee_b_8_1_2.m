function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D)
    ...
    patch([A(1) B(1) C(1) D(1)], [A(2) B(2) C(2) D(2)], [A(3) B(3) C(3) D(3)], [0.8 0.8 0.8], 'FaceAlpha', 0.2);
    patch([P(1) A(1) B(1)], [P(2) A(2) B(2)], [P(3) A(3) B(3)], [0.9 0.7 0.7], 'FaceAlpha', 0.2);
    patch([P(1) B(1) C(1)], [P(2) B(2) C(2)], [P(3) B(3) C(3)], [0.7 0.9 0.7], 'FaceAlpha', 0.2);
    patch([P(1) C(1) D(1)], [P(2) C(2) D(2)], [P(3) C(3) D(3)], [0.7 0.7 0.9], 'FaceAlpha', 0.2);
    patch([P(1) D(1) A(1)], [P(2) D(2) A(2)], [P(3) D(3) A(3)], [0.9 0.9 0.7], 'FaceAlpha', 0.2);
    ...
    text(P(1)-0.1, P(2)-0.1, P(3)+0.2, point_P, 'FontSize', 12, 'FontWeight', 'bold');
