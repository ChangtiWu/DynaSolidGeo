function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_Q)
    ...
    B = [3, -0.9, 0];     
    C = [3, 2, 0];      
    Q = [(P(1)+B(1))/2, (P(2)+B(2))/2, (P(3)+B(3))/2]; 
    ...
    text(P(1)-0.3, P(2)-0.3, P(3)+0.3, point_P, 'FontSize', 14, 'FontWeight', 'bold');
    ...
    text(Q(1)+0.3, Q(2)-0.2, Q(3), point_Q, 'FontSize', 14, 'FontWeight', 'bold');
