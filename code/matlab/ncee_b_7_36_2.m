function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_E)
    ...
    patch([A(1), P(1), D(1)], [A(2), P(2), D(2)], [A(3), P(3), D(3)], 'm', 'FaceAlpha', 0.3);
    patch([C(1), P(1), D(1)], [C(2), P(2), D(2)], [C(3), P(3), D(3)], 'g', 'FaceAlpha', 0.2);
    ...
    text(D(1), D(2)+0.1, D(3), point_D, 'FontSize', 12, 'FontWeight', 'bold');
