...
function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_A1, point_M, point_S, point_T)
    ...
    text(B(1)-0.1, B(2)-0.4, B(3), point_B, 'FontSize', 14, 'FontWeight', 'bold');
    text(C(1)+0.1, C(2)-0.5, C(3), point_C, 'FontSize', 14, 'FontWeight', 'bold');
    text(D(1)-0.1, D(2)-0.3, D(3)-0.1, point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(E(1)+0.1, E(2)+0.1, E(3), point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(M(1)+0.1, M(2)-0.5, M(3), point_M, 'FontSize', 14, 'FontWeight', 'bold');
    text(S(1)-0.2, S(2), S(3)+0.2, point_S, 'FontSize', 14, 'FontWeight', 'bold');
    text(T(1)-0.2, T(2), T(3)+0.2, point_T, 'FontSize', 14, 'FontWeight', 'bold');
