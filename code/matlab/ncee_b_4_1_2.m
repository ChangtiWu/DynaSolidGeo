function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_O, point_E)
    close all;
    ...
    OA_len = sqrt(half_side^2 + half_side^2);
    PO_height = sqrt(AP_len^2 - OA_len^2);
    P = [0, 0, PO_height];
    ...
    text(O(1), O(2)-0.4, O(3), point_O, 'FontSize', 12, 'FontWeight', 'bold');
