function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_P, point_E, point_D)
    close all;
    ...
    PC_vec = C - P;
    AC_vec = C - A;
    t = (dot(E-A, PC_vec)) / (dot(AC_vec, PC_vec));
    D = A + t * AC_vec;
    ...
    all_points_labels = {point_P, point_A, point_B, point_C, point_D, point_E};
    all_points_coords = {P, A, B, C, D, E};
    offsets = {[0, 0.2, 0.2], [0, 0.3, 0], [-0.2, -0.2, 0], [0.2, -0.2, 0], ...
               [-0.3, 0.2, 0], [0.2, 0.2, 0.2]};
