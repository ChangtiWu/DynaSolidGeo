function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_F, point_M)
    close all;
    ...
    text(E(1)+0.2, E(2), E(3)+0.1, point_E, 'FontSize', 12, 'FontWeight', 'bold');
    text(F(1)-0.2, F(2), F(3)+0.1, point_F, 'FontSize', 12, 'FontWeight', 'bold');
    text(M(1), M(2)-0.2, M(3), point_M, 'FontSize', 14, 'FontWeight', 'bold');
