...
function visual(mode, azimuth, elevation, point_O, point_O1, point_A, point_B, point_B1)
    ...
    text(B1(1)+0.2, B1(2)-0.2, B1(3), point_B1, 'FontSize', 14, 'FontWeight', 'bold');
    
    text(O(1), O(2)-0.3, O(3), point_O, 'FontSize', 14, 'FontWeight', 'bold');
    text(O1(1), O1(2)-0.3, O1(3), point_O1, 'FontSize', 14, 'FontWeight', 'bold');
