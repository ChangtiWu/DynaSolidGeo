function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_P, point_M, point_N)
    ...
    M = [(P(1)+B(1))/2, (P(2)+B(2))/2, (P(3)+B(3))/2]; 
    N = [1, 3, 0];    
    ...
    plot3([M(1), B(1)], [M(2), B(2)], [M(3), B(3)], 'k-', 'LineWidth', 2); 
    ...
    text(P(1)-0.3, P(2), P(3)+0.3, point_P, 'FontSize', 14, 'FontWeight', 'bold');
    text(B(1)+0.3, B(2)-0.3, B(3)-0.2, point_B, 'FontSize', 14, 'FontWeight', 'bold');
    text(C(1)+0.3, C(2)+0.3, C(3)+0.2, point_C, 'FontSize', 14, 'FontWeight', 'bold');
    text(D(1)-0.3, D(2)+0.3, D(3)+0.2, point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(E(1)+0.3, E(2)-0.3, E(3)-0.2, point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(M(1)-1, M(2)+0.2, M(3)-0.5, point_M, 'FontSize', 14, 'FontWeight', 'bold');
    text(N(1)+0.3, N(2), N(3)+0.2, point_N, 'FontSize', 14, 'FontWeight', 'bold');
