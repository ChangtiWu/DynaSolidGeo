function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_E, point_F)
    ...
    patch([B(1), A(1), D(1)], [B(2), A(2), D(2)], [B(3), A(3), D(3)], 'm', 'FaceAlpha', 0.3);
    patch([F(1), A(1), D(1)], [F(2), A(2), D(2)], [F(3), A(3), D(3)], 'g', 'FaceAlpha', 0.2);
    ...
    plot3([B(1), F(1)], [B(2), F(2)], [B(3), F(3)], 'b-', 'LineWidth', 2.5);
