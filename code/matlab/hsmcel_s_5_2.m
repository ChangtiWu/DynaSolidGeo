function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_P, point_E, point_F)
    close all;
    ...
    all_points_labels = {point_A, point_B, point_C, point_D, point_E, point_F, point_P};
    all_points_coords = {A, B, C, D, E, F, P};
    offsets = {[-0.3, -0.3, 0], [0.3, -0.3, 0], [0.3, 0.3, 0], [-0.3, 0.3, 0], ...
               [0, -0.4, 0], [-0.4, 0, 0], [0.2, 0.2, 0.2]};
