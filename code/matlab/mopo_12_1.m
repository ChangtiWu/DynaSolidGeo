function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_A1, point_B1, point_C1, point_D1, point_M)
    ...
    plot3([D1(1), C(1)], [D1(2), C(2)], [D1(3), C(3)], 'k-', 'LineWidth', 2);
    ...
    plot3([B(1), D1(1)], [B(2), D1(2)], [B(3), D1(3)], 'k--', 'LineWidth', 1.5);
    
    
    plot3([D(1), P(1)], [D(2), P(2)], [D(3), P(3)], 'k--', 'LineWidth', 1.5);
    
    
    plot3([N(1), Q(1)], [N(2), Q(2)], [N(3), Q(3)], 'k--', 'LineWidth', 2);
    plot3([N(1), P(1)], [N(2), P(2)], [N(3), P(3)], 'k--', 'LineWidth', 2);
    plot3([R(1), A(1)], [R(2), A(2)], [R(3), A(3)], 'k--', 'LineWidth', 2);
    plot3([R(1), P(1)], [R(2), P(2)], [R(3), P(3)], 'k--', 'LineWidth', 2);
    plot3([D(1), Q(1)], [D(2), Q(2)], [D(3), Q(3)], 'k--', 'LineWidth', 2);
    ...
    text(P(1), P(2), P(3), 'p', 'FontSize', 14, 'FontWeight', 'bold');
