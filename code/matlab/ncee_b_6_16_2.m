function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_A4, point_E, point_F)
    close all;
    ...
    all_points_labels = {point_A, point_B, point_C, point_A1, point_E, point_F};
    all_points_coords = {A, B, C, A1, E, F};
