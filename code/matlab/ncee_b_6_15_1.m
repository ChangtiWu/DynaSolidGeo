function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_G, point_H)
    close all;
    ...
    all_points_labels = {point_A, point_B, point_C, point_D, point_P, point_G, point_H};
    all_points_coords = {A, B, C, D, P, G, H};
    offsets = {[0.1, 0.2, 0.1], [-0.2, 0.2, 0], [0.1, -0.2, -0.1], [0.2, -0.1, 0], ...
               [0, 0.1, 0.2], [-0.2, 0.1, 0.1], [0.1, -0.2, 0]};
