function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_A1, point_B1, point_C1, point_E, point_F)
    ...
    all_points_labels = {point_A, point_B, point_C, point_A1, point_B1, point_C1, point_E, point_F};
    all_points_coords = {A, B, C, A1, B1, C1, E, F};
    offsets = {[-0.1, -0.2, -0.1], [0.1, 0.2, -0.1], [0.2, -0.2, 0], ...
               [0, 0.1, 0.2], [0.1, 0.2, 0.2], [0.2, -0.1, 0.2], ...
               [0, -0.3, 0], [0, -0.2, 0.2]};
