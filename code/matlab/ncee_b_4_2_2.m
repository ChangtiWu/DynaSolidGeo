function visual(mode, azimuth, elevation, point_P, point_A, point_B, point_C, point_D, point_E, point_O, point_F)
    close all;
    ...
    text(P(1), P(2)-0.1, P(3)+0.1, point_P, 'FontSize', 12, 'FontWeight', 'bold');
    text(D(1)-0.1, D(2)-0.2, D(3)+0.1, point_D, 'FontSize', 14, 'FontWeight', 'bold');
    text(E(1)+0.15, E(2)+0.15, E(3)+0.1, point_E, 'FontSize', 14, 'FontWeight', 'bold');
    text(O(1), O(2)-0.3, O(3), point_O, 'FontSize', 14, 'FontWeight', 'bold');
    text(F(1), F(2)+0.3, F(3), point_F, 'FontSize', 14, 'FontWeight', 'bold');
