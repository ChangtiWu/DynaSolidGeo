function visual(mode, azimuth, elevation, point_A, point_B, point_C, point_D, point_A1, point_B1, point_C1, point_D1)
    ...
    plot3([A1(1), D1(1)], [A1(2), D1(2)], [A1(3), A1(3)], 'k-', 'LineWidth', 2);
    ...
    labels = {point_A,point_B,point_C,point_D,point_A1,point_B1,point_C1,point_D1};
    for i = 1:length(all_points)
        pt = all_points{i};
        scatter3(pt(1), pt(2), pt(3), 25, 'ko', 'filled');
        text(pt(1)+0.05, pt(2)+0.05, pt(3)+0.05, labels{i}, 'FontSize', 12, 'FontWeight', 'bold');
    end
