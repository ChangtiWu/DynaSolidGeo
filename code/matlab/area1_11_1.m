function visual(mode, azimuth, elevation, point_C, point_V, point_O)
    ...
    text(S(1)+0.1, S(2)+0.1, S(3)+0.1, point_V, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    
    text(O(1)+0.1, O(2)+0.1, O(3)+0.1, point_C, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
    text(O1(1)+0.1, O1(2)+0.1, O1(3)+0.1, point_O, 'FontSize', 14, 'Color', 'black','FontWeight', 'bold');
