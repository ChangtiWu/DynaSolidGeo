...
json_data = {
    ...
    "type": 7,
    "level": 2,
    "cn_problem": f"在棱长为 ${len_a}$ 的正方体 {point_A}{point_B}{point_C}{point_D}-{point_A1}{point_B1}{point_C1}{point_D1} 中，点 {point_E}、{point_F} 分别是棱 ${point_B}{point_C}$、${point_C}{point_C1}$ 的中点，{point_P} 是侧面四边形 {point_B}{point_C}{point_C1}{point_B1} 内（不含边界）一点，若 ${point_A1}{point_P} \\\\parallel$ 平面 {point_A}{point_E}{point_F}，求线段 ${point_A1}{point_P}$ 长度的最小值。",
...
with open(matlab_cmd_jsonl_path, "a", encoding="utf-8") as f:
    f.write(json.dumps({json_data["id"]: f"mopo_29_1_1({mode}, {azimuth}, {elevation}, '{point_A}', '{point_B}', '{point_C}', '{point_D}', '{point_A1}', '{point_B1}', '{point_C1}', '{point_D1}', '{point_E}', '{point_F}', '{point_P}')"}, ensure_ascii=False) + "\n")
